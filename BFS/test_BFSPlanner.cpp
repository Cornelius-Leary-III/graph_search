...
TEST(BFS_Planner_process_setup_header, empty_file)
{
   ...
   planner.processGraphSetupHeaderOnly("tests/empty_test_file.txt");
...
TEST(BFS_Planner_process_setup_header, missing_start_and_goal_nodes)
{
   ...
   planner.processGraphSetupHeaderOnly("tests/missing_start_and_goal.txt");
...
TEST(BFS_Planner_process_setup_header, missing_goal_node)
{
   ...
   planner.processGraphSetupHeaderOnly("tests/missing_goal.txt");
...
TEST(BFS_Planner_process_setup_header, all_setup_info_present)
{
   ...
   planner.processGraphSetupHeaderOnly("tests/input1.txt");
...
TEST(BFS_Planner_import_graph_to_adj_list, empty_file)
{
   ...
   planner.importGraphToAdjList("tests/empty_test_file.txt");
...
TEST(BFS_Planner_import_graph_to_adj_list, missing_start_and_goal_nodes)
{
   ...
   planner.importGraphToAdjList("tests/missing_start_and_goal.txt");
...
TEST(BFS_Planner_import_graph_to_adj_list, missing_goal_node)
{
   ...
   planner.importGraphToAdjList("tests/missing_goal.txt");
...
TEST(BFS_Planner_import_graph_to_adj_list, only_header_no_edges)
{
   ...
   planner.importGraphToAdjList("tests/setup_info_only.txt");
...
TEST(BFS_Planner_search_for_goal, only_2_nodes_start_and_goal)
{
   ...
   planner.importGraphToAdjList("tests/only_2_nodes_no_path_to_goal_in_graph.txt");
...
{
   BFS_Planner planner;
   string      inputFile = "tests/input1.txt";
...
TEST(BFSPlanner_class, import_and_search_weighted_graph)
{
   ...
   string inputFile = "tests/input2.txt";
