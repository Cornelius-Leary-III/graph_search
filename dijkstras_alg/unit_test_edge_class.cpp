...
TEST(EdgeCtor, defaultCtor)
{
   ...
   EXPECT_EQ(test_edge.mSource.mName, "0");
   EXPECT_EQ(test_edge.mDestination.mName, "0");
...
TEST(EdgeParamsCtor, source_destination)
{
   ...
   EXPECT_EQ(test_edge.mSource.mName, "5");
   EXPECT_EQ(test_edge.mDestination.mName, "10");
...
TEST(EdgeCopyCtor, valid_edge)
{
   ...
   EXPECT_EQ(test_edge.mSource.mName, "3");
   EXPECT_EQ(test_edge.mDestination.mName, "9");
