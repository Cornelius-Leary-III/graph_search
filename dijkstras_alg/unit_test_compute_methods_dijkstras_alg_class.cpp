...
{
   vector<Edge> input_edges{{0, 1}, {0, 2}, {0, 3}, {1, 3}, {1, 4}, {2, 3}, {3, 4}, {2, 5}, {4, 5}};
...
TEST(returnPathFromStartToGivenNode, unweightedGraph)
{
   ...
   auto expected_path_00 = vector<int>{0};
   auto expected_path_01 = vector<int>{0, 1};
   auto expected_path_02 = vector<int>{0, 2};
   auto expected_path_03 = vector<int>{0, 3};
   auto expected_path_04 = vector<int>{0, 3, 4};
   auto expected_path_05 = vector<int>{0, 2, 5};
...
TEST(returnPathFromStartToGivenNode, weightedGraph)
{
   ...
   auto expected_path_00 = vector<int>{0};
   auto expected_path_01 = vector<int>{0, 1};
   auto expected_path_02 = vector<int>{0, 3, 2};
   auto expected_path_03 = vector<int>{0, 3};
   auto expected_path_04 = vector<int>{0, 3, 4};
   auto expected_path_05 = vector<int>{0, 3, 2, 5};
